...
function VetsMembership() {
  
  const actionVetsLoginWithZustand = useAuthStore(
    (state) => state.actionVetsLoginWithZustand
  );
  ...
  const hdlSubmit = async (value) => {
    console.log("test2");
    const res = await actionVetsLoginWithZustand(value);
