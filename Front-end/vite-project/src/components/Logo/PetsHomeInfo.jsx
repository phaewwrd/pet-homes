...
function PetsHomeInfo() {
  return (
    ...
    {/* Info and Icons */}
        <div className="grid grid-cols-4  w-full bg-gray-50 px-[120px] h-full pb-20 pt-10 justify-evenly gap-10">
        <div className="flex flex-col text-center place-items-center">
        <VetsLocationLogo className="w-[100px] text-accent "/>
                <div><span className="text-md font-semibold">🏥 Comprehensive </span>🏥 Comprehensive Network of Veterinary Hospitals & Clinics
                </div>
{/* <div>Our website gathers veterinary hospitals and clinics from all over the country in one place, making it easy for you to find the best care facility for your pet.</div> */}
            ...
            <div className="flex flex-col text-center place-items-center ">
                ...
                <div><span className="text-md font-semibold">🐦 Care  </span>for All Types of Pets
                </div>
{/* <div>Whether you have a dog, cat, rabbit, or exotic pet, we provide information on specialized veterinary services to ensure your pet gets the best possible treatment.</div> */}
            ...
            <div className="flex flex-col text-center place-items-center ">
                ...
                <div ><span className="text-md font-semibold">🩺 Convenient </span> & Fast Online Appointment Booking
                </div>
{/* <div>Easily book veterinary appointments online, reducing wait times and ensuring your pet receives expert care at your preferred time.</div> */}
            ...
            <div className="flex flex-col text-center place-items-center  ">
                ...
                <div><span className="text-md font-semibold">📋 Track </span> Treatment Progress Anytime, Anywhere
                </div>
